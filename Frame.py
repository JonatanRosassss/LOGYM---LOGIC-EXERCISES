...
class MainFrame(wx.Frame):
    def __init__(self, parent=None, title="LoGym"):
        ...
        self.vincular_todos_los_eventos_de_los_botones_y_menus()

    def vincular_todos_los_eventos_de_los_botones_y_menus(self):
        self.Bind(wx.EVT_MENU, self.cuando_el_usuario_quiere_cerrar_y_salir_de_la_app, id=wx.ID_EXIT)
        self.Bind(wx.EVT_MENU, self.cuando_el_usuario_toca_el_boton_de_acerca_de, id=wx.ID_ABOUT)

        # self.Bind(wx.EVT_MENU, self._on_click_planeta, id=101)
        # self.Bind(wx.EVT_MENU, self._on_click_planeta, id=102)
        self.Bind(wx.EVT_MENU, self.cuando_el_usuario_hace_click_en_importar_pack_json, id=wx.ID_OPEN)
        self.Bind(wx.EVT_MENU, self.cuando_el_usuario_toca_el_item_del_menu_planeta, id=wx.ID_NEW)
    def cuando_el_usuario_quiere_cerrar_y_salir_de_la_app(self, event):
        self.Close(True)

    def cuando_el_usuario_hace_click_en_importar_pack_json(self, event):
    ...
    def cuando_el_usuario_toca_el_boton_de_acerca_de(self, event):
