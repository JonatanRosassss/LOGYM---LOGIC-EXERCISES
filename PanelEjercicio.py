...
class PanelEjercicio(wx.Panel):
    ...
    def crear_caja_texto_para_el_enunciado(self):
        ...
        self.caja_grande_texto_enunciado = wx.TextCtrl(self, style=wx.TE_MULTILINE | wx.TE_READONLY | wx.NO_BORDER | wx.TE_RICH)
        self.caja_grande_texto_enunciado.SetBackgroundColour(wx.Colour(100, 100, 100))
        self.caja_grande_texto_enunciado.SetForegroundColour(wx.WHITE)
        self.caja_grande_texto_enunciado.SetFont(wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL))
