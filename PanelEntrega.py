...
class PanelEntrega(wx.Panel):
    def __init__(self, parent):
        ...
        self.crear_seccion_con_el_input_a_colocar()
        self.crear_seccion_para_que_el_usuario_pegue_su_output()
    ...
    def crear_seccion_con_el_input_a_colocar(self):
    ...
    def crear_seccion_para_que_el_usuario_pegue_su_output(self):
